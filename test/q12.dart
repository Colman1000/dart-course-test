...
void main() {
  group('Rectangle Class Tests', () {
    ...
    test('Calculate Area and Perimeter for very small rectangle; Rectangle(0.001, 0.002)', () {
    ...
    test('Calculate Area and Perimeter for rectangle with negative length and width; Rectangle(-4, -6)', () {
